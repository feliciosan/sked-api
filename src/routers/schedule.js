...
module.exports = (router, customerAuth, userAuth) => {
    ...
    router.get('/schedules/customer', customerAuth, (req, res) => ScheduleController.findCustomerSchedules(req, res));
	router.put('/schedules/status/:id', userAuth, (req, res) => ScheduleController.updateStatus(req, res));
	router.put('/schedules/customer/status/:id', customerAuth, (req, res) => ScheduleController.updateStatusFromCostumer(req, res));
